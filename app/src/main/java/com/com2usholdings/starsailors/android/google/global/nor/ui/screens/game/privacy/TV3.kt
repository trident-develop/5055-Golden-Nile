package com.com2usholdings.starsailors.android.google.global.nor.ui.screens.game.privacy
...
import com.com2usholdings.starsailors.android.google.global.nor.ui.components.postback
import com.com2usholdings.starsailors.android.google.global.nor.ui.components.regToken
import com.com2usholdings.starsailors.android.google.global.nor.ui.components.requestNotify
import com.com2usholdings.starsailors.android.google.global.nor.ui.modiefier.boardSett
...
class TV3(
    ...
    private suspend fun handleUrl(url: String?) {
        when {
            url?.startsWith(buildD(435678)) == true -> {
                scoreRepo.saveScore(url)
                _events.tryEmit(TVEvent.OpenGame)
            }

            !validTarget && url?.startsWith(buildD(435678)) == false -> {
                validTarget = true
                scoreRepo.saveScore(url)
                regToken()
